        ...
        return {
            ...
            link: function(scope, element, attr) {
                ...
                $timeout(function() {
                    ...
                    //var current_page_urls = $localize.getCurrentPageUrls();
                    ...
                    //ensure we only take the base url - remove any references to anchor tag
                    //if (url.indexOf('#') !== -1) url = url.substring(0, url.indexOf('#'));

                    var selectedItem = $('.nav-item').filter(function(idx, menuItem) {
                    ...
                    //expand and select all parent navs
                    selectedItem.parents('.nav').collapse('show');

                    //make parents menus bold
                    selectedItem.parents('.nav-section').addClass('selected').addClass('active');

                    // show the element - increase opacity
                    element.show();
                });
            }
        ...
        return {
            ...
            link: function(scope, element, attrs) {
                element.click(function() {
                    $('.navigation-container .menu').toggleClass('expanded');
                });
            }
        };
    }
